...
exports.default = {
  ...
  methods: {
    ...
    setElementModifiersDescriptor: function setElementModifiersDescriptor(object, name, parent, block, element, override) {
      var _this = this;

      this.setModifiersDescriptor(object[name], function () {
        return parent.querySelector('.' + _this.elementString(block, name));
      }, this.elementString(block, name), element, override);
    },
