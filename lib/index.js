...
exports.default = {
  ...
  methods: {
    ...
    booleanModifierDescriptor: function booleanModifierDescriptor(node, name, modifier) {
      ...
      return {
        get: function get() {
          return _this2.getBooleanModifier(node, modifier);
        },
        set: function set(value) {
          return _this2.setBooleanModifier(node, modifier, value);
        }
      };
    },
    ...
    stringModifierDescriptor: function stringModifierDescriptor(node, name, modifier) {
      ...
      return {
        get: function get() {
          return _this3.getStringModifier(node, modifier);
        },
        set: function set(value) {
          return _this3.setStringModifier(node, modifier, value);
        }
      };
    },
